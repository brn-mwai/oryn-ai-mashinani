...
import { Icon } from "@/lib/basehub-stubs/react-icon";

export const $button = cva(
  "gap-1 font-normal shrink-0 rounded-none ring-[--control] focus-visible:ring-2 outline-hidden outline-0",
  {
    variants: {
      intent: {
        primary:
        ...
        secondary:
          "bg-[--surface-secondary] text-[--text-primary] border-[--border] border dark:bg-[#243840] dark:text-[--dark-text-primary] dark:border-[#3a4f58] hover:bg-[--surface-tertiary] dark:hover:bg-[#2e454e]",
        tertiary:
          "bg-[--text-primary] text-[--surface-primary] dark:bg-[--dark-text-primary] dark:text-[--dark-surface-primary] border border-[#3a4f58] dark:border-[--border] hover:bg-[--dark-surface-tertiary] dark:hover:bg-[--surface-tertiary]",
      },
      disabled: {
        true: "opacity-30",
      },

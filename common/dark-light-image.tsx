...
// Helper to determine if URL is local
...
export function DarkLightImage({
  ...
  const ImageComponent = isLocalUrl(light.url) ? Image : BaseHubImage;
  const DarkImageComponent = dark && isLocalUrl(dark.url) ? Image : BaseHubImage;

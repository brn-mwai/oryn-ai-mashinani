...
export default function SignUpPage() {
  return (
    <AuthLayout
      ...
      subtitle="Create your account and let Oryn handle your payment collection."
      heroTitle="AI-powered payment collection for creators"
      heroSubtitle="Join Oryn today"
    >
      <SignUp
        appearance={{
          elements: {

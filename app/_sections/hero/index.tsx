...
export function Hero(hero: Hero & { eventsKey: GeneralEvents["ingestKey"] }) {
  return (
    <section className="relative min-h-[calc(630px-var(--header-height))] overflow-hidden pb-10">
      {/* Decorations - hidden on mobile, visible on md+ */}
      <div className="absolute left-0 top-0 z-0 h-full w-full border-b border-[--border] dark:border-[--dark-border] md:hidden" />
      <div className="absolute left-0 top-0 z-0 hidden h-full w-full border-b border-[--border] dark:border-[--dark-border] md:grid md:grid-cols-[clamp(28px,10vw,120px)_auto_clamp(28px,10vw,120px)]">
